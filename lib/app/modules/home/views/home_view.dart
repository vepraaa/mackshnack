                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child: TextButton(
                      onPressed: () {
                        // final catProducts =
                        //     getCategoryProducts(products, 'Drinks');
                        // showDialog(
                        //     context: context,
                        ...
                        //             return ListTile(
                        //               leading: Image.asset(catProducts[index].image),
                        //               title: Text(catProducts[index].name),
                        //               subtitle: Text('${catProducts[index].price.toString()} руб'),
                        //               onTap: () {
